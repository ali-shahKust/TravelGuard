package com.kustit.edu.travelguard.EditUserProfile.Presenter
...
import com.kustit.edu.travelguard.EditUserProfile.Model.Model
            ...
            if (task.isSuccessful) {
                ...
                FirebaseAuth.getInstance().currentUser!!.updateProfile(userProfileChangeRequest!!).addOnCompleteListener { task ->
                    if (task.isSuccessful) {
                        ...
                        map["uid"] = FirebaseAuth.getInstance().uid!!.toString()
